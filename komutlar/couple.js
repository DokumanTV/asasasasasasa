...
exports.run = async (bot, message, args) => {
    ...
    message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`${rMember} isimli üyeye \`${role.name}\` isimli yetki başarıyla verildi! <a:elmas2:701864531835748483>`).setColor('RANDOM'));
