...
exports.run = (client, message, args) => {
  const kayıtlı = message.guild.roles.find(r => r.id === "706850264648515674"); //buraya erkek rolünüzün id'sini koyun
  const male = message.guild.roles.find(r => r.id === "706850123971297322"); //buraya erkek rolünüzün id'sini koyun
