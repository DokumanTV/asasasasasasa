...
exports.run = (client, message, args) => {
  const kayıtlı = message.guild.roles.find(r => r.id === "705854560106971257"); //buraya erkek rolünüzün id'sini koyun
  const male = message.guild.roles.find(r => r.id === "705854561151090688"); //buraya erkek rolünüzün id'sini koyun
