...
.setTitle(`🤖 » ${client.user.username} Yardım Menüsü`)
  .setTimestamp()
      ...
      .addField(":link:・LİNKLER", "> [Botu Ekle!](https://discord.com/oauth2/authorize?client_id=791213780138852392&permissions=8&scope=bot), > [Destek Sunucu!](https://discord.gg/tDvherygAe)")
      .addField("", "> [Destek Sunucu!](https://discord.gg/tDvherygAe)")
