...
.setTitle(`🤖 » ${client.user.username} Yardım Menüsü`)
      ...
      .addField(`:speech_balloon: ・DİĞER KODLAR`, `> :one: **[${prefix}sunucu-kur](https://discord.gg/tDvherygAe)** :  Sunucu Kurar (Rollerin İzinlerini Ayarlayın)\n> :two: **[${prefix}öneri](https://discord.gg/tDvherygAe)** : Önerinizi Yazailirsiniz\n> :three: **[${prefix}depremler](https://discord.gg/tDvherygAe)** : En Son Olan 10 Depremi Gösterir`)
