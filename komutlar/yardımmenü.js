...
.setTitle(`🤖 » ${client.user.username} Yardım Menüsü`)
      ...
      .addField(`:speech_balloon: ・DİĞER KODLAR`, `> :one: **[${prefix}sunucu-kur](https://discord.gg/tDvherygAe)** :  Sunucu Kurar (Rollerin İzinlerini Ayarlayın)\n> :two: **[${prefix}ailemiz](https://discord.gg/tDvherygAe)** :  Botun Ekli Olduğu Sunucuları Listeler\n> :three: **[${prefix}öneri](https://discord.gg/tDvherygAe)** : Önerinizi Yazailirsiniz`)
