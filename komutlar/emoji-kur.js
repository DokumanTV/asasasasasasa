  ...
  message.channel
    ...
    .then(collected => {
      ...
      message.guild
        ...
        .then(Emoji =>
          message.guild
            .emojis.create(`https://c.tenor.com/g5apIPzBovwAAAAi/weewoo-emote.gif`, "mavisiren")
            .then(tm => {
              message.channel.send("Emoji oluşturuldu");
            })
            .catch(error => {
        ...
        .then(Emoji =>
          message.guild
            .emojis.create(
              `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRL3B32UADQXoBdvv1MvSod9PpTsXecOOZgQw&usqp=CAU`,
              "got"
            )
            .then(tm => {
              message.channel.send("Emoji oluşturuldu");
