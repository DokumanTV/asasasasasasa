...
db.set(`Döküman TV`,`Bu Sunucunun Sahibi`)
db.set(`İnek`,`Möö Sesini Çıkartan Hayvan.`)
...
//Amil <3 ///////////////////
      var kelimeler = ['Klostrofobi','Türkçe','Domates','Otel','Söğüt','Veteriner','Airafe','İnek','Magnum','Lüksemburg','Deve'];
...
if (!message.author.bot) { 
              ...
              console.log('Döküman TV\'Adamdır') //burayı silende ne bilim.
